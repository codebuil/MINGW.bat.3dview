...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    if (fp == NULL) {
        ...
        if(i>6) {
                ...
                coords[counts]=wasm_draw3Dx(atoi(fields[1]),atoi(fields[2]),atoi(fields[3]));
                counts++;
                coords[counts]=wasm_draw3Dy(atoi(fields[1]),atoi(fields[2]),atoi(fields[3]));
                counts++;
                coords[counts]=wasm_draw3Dx(atoi(fields[4]),atoi(fields[5]),atoi(fields[6]));
                counts++;
                coords[counts]=wasm_draw3Dy(atoi(fields[4]),atoi(fields[5]),atoi(fields[6]));;
                counts++;
